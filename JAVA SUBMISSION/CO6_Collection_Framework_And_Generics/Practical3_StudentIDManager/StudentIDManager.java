/*
 * Problem Definition:
 * Develop a Java program to manage a collection of unique Student IDs in a university.
 * 1. Store unique IDs using HashSet to prevent duplicates.
 * 2. Display IDs in sorted order using TreeSet.
 * 3. Maintain the order of insertion using LinkedHashSet.
 * Menu-driven options:
 * 1. Add a new Student ID
 * 2. Remove an existing ID
 * 3. Check if a particular ID exists
 * 4. Display all IDs:
 *    a. Unordered (HashSet)
 *    b. Sorted (TreeSet)
 *    c. Insertion order (LinkedHashSet)
 * CO6
 */
